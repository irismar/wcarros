...
$url_cidade=NormalizaURL($cliente->cidade);
$url_estado=NormalizaURL($cliente->estado);
$url_modelo=NormalizaURL($modelo. $versao);
$url_marca=NormalizaURL($modelo);
...
VALUES(:data, :data_cadastro,:id_membro,:nome_membro,:foto_membro,:marcatexto,:modelotexto,:url_marca,:url_modelo,:preco,:km,:combustivel,:lat,:lon,:endereco,:cidade,:estado,:url_cidade,:url_estado,:watapps,:url)';
$stm = $conexao->prepare($sql);
            ...
            $stm->bindValue(':modelotexto',  $modelo. $versao);
             $stm->bindValue(':url_marca',  $url_marca);
            $stm->bindValue(':url_modelo',  $url_modelo);
            ...
            $stm->bindValue(':url_cidade', $membro->url_cidade);
            $stm->bindValue(':url_estado', $membro->url_estado);
